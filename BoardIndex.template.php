...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			...
			<div class="baslik">
				<span></span>
				<span>'.$txt['bese_board_topic'].'</span>
				<span>'.$txt['bese_board_infor'].'</span>
				<span>'.$txt['bese_board_last'].'</span>
			</div>
			<div id="category_', $category['id'], '_boards" class="boardtech ', (!empty($category['css_class']) ? ($category['css_class']) : ''), '">';
